...
import diaryPostService from "../../../Services/DiaryPostService";
import Input from "../../../Components/Input";
import Button from "../../../Components/Button";
import Pagination from "@material-ui/lab/Pagination";

const DiaryPostListPatient = (props) => {
    ...
    const retrieveDoctors = () => {
        ...
        diaryPostService.getAll(params)
            .then((response) => {
    ...
    const openDoctor = (rowIndex) => {
        ...
        diaryPostService.get(id);
    };

    const deleteDoctor = (rowIndex) => {
        const id = doctorsRef.current[rowIndex].id;
        diaryPostService.remove(id)
            .then((response) => {
    ...
    return (
        <MainContainer>
            <div className="mb-3" style={{ color: "white"}}>
                <HeaderText className='GradientText' style={{ fontSize: "2.6em", fontWeight: "bolder"}}>Betegnapló bejegyzései</HeaderText>
            </div>
            <div>
                <BlogsSectionStyled>
                    <div className="blogs">
...
export default DiaryPostListPatient;